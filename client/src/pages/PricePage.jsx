...
const priceCategories = [
  ...
  },
  {
    ...
    services: [
      { name: 'Полировка кузова',              price: 'от 7 000 ₽',   note: 'абразивная + защитная' },
      { name: 'Полировка одного элемента',     price: 'от 1 500 ₽',   note: 'устранение царапин' },
      { name: 'Антикоррозийная обработка',     price: 'от 9 000 ₽',   note: 'днище, арки, полости' },
      { name: 'Замена лобового стекла',        price: 'от 1 500 ₽',   note: 'без стоимости стекла' },
      { name: 'Замена бокового стекла',        price: 'от 400 ₽',     note: 'без стоимости стекла' },
...
const faq = [
  ...
  },
  {
    ...
    a: 'Да, можно приехать в рабочее время для бесплатной оценки повреждений. Запись не обязательна — мастер осмотрит автомобиль и назовёт стоимость и сроки ремонта на месте.',
  },
]
